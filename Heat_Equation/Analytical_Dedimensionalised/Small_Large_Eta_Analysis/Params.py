...
etaList = np.arange(1e-3,1e1,1e-3)#np.arange(1e-1,1e2,1e-1)#1e-4,1e-0,1e-4)#np.arange(1e-4,5e-2,1e-4)

rhoList = np.arange(0.1,0.9,0.01)#np.arange(0,1.0,0.1)#np.arange(0,1.0,0.01)
