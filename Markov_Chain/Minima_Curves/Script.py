...
##############################################################################
#SaveFileCreation
SaveFileName = ("Saved_Plots/Years_%d_PAP_%d_gSS_%0.3f_Characteristic_%0.3f_RefugeAttract_%0.3f_GradientRange_%d_BreedingTime_%d"%
                (Years,Pesticide_Application_Period,Pesticide_SS,Characteristic,Refuge_Attract,GradientRange,BreedingTime))
if FLATPESTICIDE:
