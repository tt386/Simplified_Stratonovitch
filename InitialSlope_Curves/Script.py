...
SystemSizes = np.arange(8,1000,8)
OSR_Proportion = 0.25
...
##############################################################################
#SaveFileCreation
SaveFileName = ("Saved_Plots/OSRProportion_%0.3f_Years_%d_InitialRRatio_"%(OSR_Proportion,Years)
                + '{:.1E}'.format(R_Allele_Ratio) + "_PAP_%d_gSS_%0.3f"%(Pesticide_Application_Period,Pesticide_SS))
if FLATPESTICIDE:
...
plt.savefig(SaveFileName + "/InitialSlopePlot.png")
#plt.show()
